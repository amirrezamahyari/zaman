...
`;He.defaultProps={clockHalfWidth:130,numbersPadd:24,top:"2%"};const Ne=t=>{const{insideHour:n,hourSelecting:r,clockTime:o}=t;return r?12===o?e.createElement(e.Fragment,null,Se.map(((t,r)=>e.createElement(He,{key:t,idx:r,style:{opacity:n?.3:1}},v(t))))):e.createElement(e.Fragment,null,Se.map(((t,r)=>e.createElement(He,{key:t,idx:r,top:"15%",clockHalfWidth:85,numbersPadd:10,style:{opacity:n?1:.3}},v(t)))),Te.map(((t,r)=>e.createElement(He,{key:t,idx:r,style:{opacity:n?.3:1}},v(t))))):e.createElement(Oe,null,Le.map(((t,n)=>e.createElement(He,{key:t,idx:n},v(t)))))},Ie=s.div`
  overflow: hidden;
  position: relative;
  display: flex;
  flex-direction: column;
